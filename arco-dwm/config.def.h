...
static Key keys[] = {
	...
	{ Mod1Mask,                     XK_Tab,    focusstack,     {.i = +1 } },        // Modified
	{ Mod1Mask|ShiftMask,           XK_Tab,    focusstack,	   {.i = -1 } },        // Modified
	...
	{ MODKEY|Mod1Mask,              XK_Return, zoom,           {0} },               // Modified
	{ MODKEY|ControlMask,           XK_Tab,    view,           {0} },               // Modified
	...
	{ MODKEY,                       XK_comma,  focusmon,       {.i = -1 } },         // Can't fiure out
	{ MODKEY,                       XK_period, focusmon,       {.i = +1 } },         // Can't fiure out
	{ MODKEY|ShiftMask,             XK_comma,  tagmon,         {.i = -1 } },         // Can't fiure out
	{ MODKEY|ShiftMask,             XK_period, tagmon,         {.i = +1 } },         // Can't fiure out

	{ MODKEY|ShiftMask,             XK_r,      self_restart,   {0} },
	
	{ Mod1Mask,                     XK_v,      spawn,          {.v = clipman } },    // Modified
