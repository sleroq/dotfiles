...
(setq place-is-open
      (and SAFE_PLACE
           ...
           (not (directory-empty-p SAFE_PLACE))))

;; `Org-mode' configuration
(load-file "~/.config/doom/config.d/org.el")
;; `Org-roam' configuration
(load-file "~/.config/doom/config.d/org-roam.el")
...
(with-eval-after-load "ispell"
  ...
  (when (eq place-is-open t)
    (setq ispell-personal-dictionary
          (concat SAFE_PLACE "/files/ispell-dictionary.txt"))))
