...
vim.keymap.set(
  ...
  { desc = '[F]ile browser in current [B]uffer' }
)
vim.keymap.set(
  "n",
  "<space>ff",
...
vim.keymap.set('n', '<leader>sb', require('telescope.builtin').builtin, { desc = '[S]earch Select Telescope' })
vim.keymap.set('n', '<leader>gff', require('telescope.builtin').git_files, { desc = 'Search [G]it [F]iles' })
