...
static const char *randombackground[]  = { "feh", "--bg-fill", "-z", "/home/sloq/Pictures/wallpapers", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_b,      spawn,          {.v = randombackground } },
	...
	{ ControlMask|MODKEY,           XK_space,  setlayout,      {0} },
